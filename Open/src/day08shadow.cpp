...
////  printf("%f, %f, %f, %f\n", floor_planar[0], floor_planar[1], floor_planar[2], floor_planar[3]);
////  floor_planar = {0.000000, -0.000000, 10000.000000, 10000.000000};
//
//  //透視変換行列の設定------------------------------
...
//}p[100];
//int pn = 0;
//const double vx = 5.0 , vy = 5.0 , vz = 20.0;
...
//    p[i].y += p[i].vy * dt;
//    p[i].z += p[i].vz * dt;
//    if(p[i].z < 4 && abs(p[i].x) < floor_s  && abs(p[i].y) < floor_s ){  // 床との衝突判定
//      p[i].z = 4.0;
...
//      glutSolidCube(4.0);//引数：(半径, Z軸まわりの分割数, Z軸に沿った分割数)
//    glPopMatrix();
//    }
//  }
//}
...
////----------------------------------------------------
////void findPlane(GLfloat plane[4],  GLfloat v0[3], GLfloat v1[3], GLfloat v2[3])
////{  //         (作成する平面方程式の係数,    頂点0,          頂点1,         頂点2)
////
////  GLfloat vec0[3], vec1[3];  // Need 2 vectors to find cross product.
////
////  vec0[0] = v1[0] - v0[0];
////  vec0[1] = v1[1] - v0[1];
////  vec0[2] = v1[2] - v0[2];
